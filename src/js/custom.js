...
function storeUserID() {
  ...
  myReader.currentHand.employee_id =
    enrollUserId !== "" ? enrollUserId : identifyUserId;
}
...
function serverIdentify() {
  ...
  xhttp.onreadystatechange = function () {
    if (this.readyState === 4 && this.status === 200) {
      console.log("Raw response:", this.responseText); // Debug log
      ...
      if (this.responseText !== null && this.responseText !== "") {
        try {
          ...
          if (response !== "failed" && response !== null) {
            ...
            detailElement.innerHTML = `<div class="col text-center">
                                ...
                                <div class="col text-center">
                                    ...
                                    <input type="text" id="email" class="form-control" value="${response[0].employee_id}">
                                </div>`;
          } else {
          ...
          console.error("Response that failed to parse:", this.responseText);
